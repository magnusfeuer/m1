...
./bin/db_rm_pf -h$DB_HOST -u$DB_USER -p$DB_PASSWORD -d$DB_DATABASE   -im1@magden-auto.com/os/$VERSION
(cd target_fs; ../bin/fs2db -h$DB_HOST -u$DB_USER -p$DB_PASSWORD -d$DB_DATABASE -s0  -im1@magden-auto.com/os/$VERSION -ab . )
rm -rf target_fs
